const sectionPage = new fullpage('#fullpage', {
	...
	// ──────────────────────────────────────────────────
		 ...
		 anchors: ['home', 'products', 'contacts'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
		 navigationTooltips: ['home', 'products', 'contacts'], // Tooltips que mostrara por cada boton.
